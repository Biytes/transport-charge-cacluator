...
export default function (http) {
    return {
        // app启动页
        getDistance: params => http.get(`https://api.mapbox.com/directions/v5/mapbox/driving/${params.longtitude1}%2C${params.latitude1}%3B${params.longtitude2}%2C${params.latitude2}?alternatives=true&exclude=motorway%2Cferry%2Cunpaved&geometries=geojson&language=en&overview=simplified&steps=true&access_token=pk.eyJ1Ijoid2Vja3NvbiIsImEiOiJjbDlpa3Y3OHMwOGdlM3Bwa3VzbXVudW5rIn0.2LA9W6XHbOFXFZgY0nGI_w`, params),
